...
public interface IUnitOfWork : IAsyncDisposable
{
    ...
    /// <summary>Gets the casual-edge repository scoped to this unit of work.</summary>
    ICasualEdgeRepository CasualEdges { get; }

    /// <summary>Gets the casual-chain repository scoped to this unit of work.</summary>
    ICasualChainRepository CasualChains { get; }
