using CasualExplorer.Application;
using CasualExplorer.Infrastructure;
...
try
{
    Log.Information("Starting CasualExplorer API");
...
{
    Log.Fatal(ex, "CasualExplorer API terminated unexpectedly");
}
finally
{
    Log.CloseAndFlush();
