...
using CausalExplorer.API.Services;
...
namespace CausalExplorer.API.Extensions;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        var issuer   = configuration["Jwt:Issuer"]   ?? "causal-explorer";
        var audience = configuration["Jwt:Audience"] ?? "causal-explorer-clients";
    ...
    public static IServiceCollection AddSwaggerDocumentation(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title       = "CausalExplorer API",
                Version     = "v1",
                Description = """
                    AI-powered causal event graph REST API.
        ...
        IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            .AddDbContextCheck<CausalExplorerDbContext>(
                name: "postgres",
