...
/// <summary>Validates <see cref="CreateCasualChainCommand"/>.</summary>
public sealed class CreateCasualChainCommandValidator : AbstractValidator<CreateCasualChainCommand>
{
    /// <summary>Defines all validation rules.</summary>
    public CreateCasualChainCommandValidator()
    {
        RuleFor(x => x.Title)
