...
/// <summary>Handles <see cref="CreateCasualChainCommand"/>.</summary>
public sealed class CreateCasualChainCommandHandler
    : IRequestHandler<CreateCasualChainCommand, CasualChainSummaryDto>
{
    ...
    public CreateCasualChainCommandHandler(
    ...
    /// <inheritdoc />
    public async Task<CasualChainSummaryDto> Handle(
        CreateCasualChainCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var chain = CasualChain.Create(request.RootEventId, request.Title, request.Domain);
        ...
        return new CasualChainSummaryDto(
            chain.Id,
            chain.RootEventId,
            chain.Title,
