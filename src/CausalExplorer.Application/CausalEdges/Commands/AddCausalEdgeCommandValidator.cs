...
/// <summary>Validates <see cref="AddCausalEdgeCommand"/>.</summary>
public sealed class AddCausalEdgeCommandValidator : AbstractValidator<AddCausalEdgeCommand>
{
    /// <summary>Defines all validation rules.</summary>
    public AddCausalEdgeCommandValidator()
    {
        ...
        RuleFor(x => x.RelationshipType)
            .IsInEnum().WithMessage("RelationshipType must be a valid CausalRelationshipType value.");
