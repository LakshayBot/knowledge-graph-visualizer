...
public sealed class GetEdgesBetweenNodesQueryHandler
    : IRequestHandler<GetEdgesBetweenNodesQuery, IReadOnlyList<CausalEdgeDto>>
{
    private readonly ICausalEdgeRepository _edgeRepo;

    /// <summary>Initialises the handler.</summary>
    public GetEdgesBetweenNodesQueryHandler(ICausalEdgeRepository edgeRepo)
    {
        _edgeRepo = edgeRepo;
    }

    /// <inheritdoc />
    public async Task<IReadOnlyList<CausalEdgeDto>> Handle(
