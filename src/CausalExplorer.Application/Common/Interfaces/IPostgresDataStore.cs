...
/// <summary>
/// Dual-write abstraction for persisting event nodes and causal edges
...
public interface IPostgresDataStore
{
    ...
    /// <summary>Bulk-adds causal edges — duplicates silently skipped.</summary>
    Task BulkAddCausalEdgesAsync(IEnumerable<CausalEdge> edges, CancellationToken ct = default);
