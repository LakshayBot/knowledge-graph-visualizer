    ...
    : IRequestHandler<SearchEventNodesQuery, PagedResult<EventNodeSummaryDto>>
{
        ...
        try
        {
            ...
            if (graph.Edges.Count > 0)
            {
                ...
                if (edges.Count > 0)
                {
                    ...
                    _logger.LogInformation("Persisted {Count} auto-generated CausalEdges.", edges.Count);
                }
            }
    ...
    private static CausalRelationshipType NormaliseRelationshipType(string raw) => raw.Trim() switch
    {
        "DirectlyCaused"        => CausalRelationshipType.DirectlyCaused,
        "EnabledConditionsFor"  => CausalRelationshipType.EnabledConditionsFor,
        "ContributedTo"         => CausalRelationshipType.ContributedTo,
        "Contested"             => CausalRelationshipType.Contested,
