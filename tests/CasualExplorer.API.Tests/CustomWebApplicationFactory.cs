...
public sealed class CustomWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    /// <summary>Mock for the casual edge repository.</summary>
    public Mock<ICasualEdgeRepository> CasualEdgeRepositoryMock { get; } = new();
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            RemoveDescriptor<DbContextOptions<CasualExplorerDbContext>>(services);
            services.AddDbContext<CasualExplorerDbContext>(opts =>
            ...
            RemoveDescriptor<ICasualEdgeRepository>(services);
            services.AddScoped<ICasualEdgeRepository>(_ => CasualEdgeRepositoryMock.Object);
